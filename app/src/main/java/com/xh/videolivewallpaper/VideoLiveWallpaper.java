...
public class VideoLiveWallpaper extends WallpaperService {
    ...
    public static final String VIDEO_PARAMS_CONTROL_ACTION = "com.xh.videolivewallpaper";
    ...
    class VideoEngine extends Engine {
        ...
        public void onDestroy() {
            Log.d("videoPaper", "VideoEngine#onDestroy");
        ...
        public void onVisibilityChanged(boolean visible) {
            Log.d("videoPaper", "VideoEngine#onVisibilityChanged visible = " + visible);
            if (visible) {
                mMediaPlayer.start();
            } else {
                mMediaPlayer.pause();
        ...
        public void onSurfaceCreated(SurfaceHolder holder) {
            Log.d("videoPaper", "VideoEngine#onSurfaceCreated ");
        ...
        public void onSurfaceChanged(SurfaceHolder holder, int format, int width, int height) {
            Log.d("videoPaper", "VideoEngine#onSurfaceChanged ");
            super.onSurfaceChanged(holder, format, width, height);
        }

        @Override
        public void onSurfaceDestroyed(SurfaceHolder holder) {
            Log.d("videoPaper", "VideoEngine#onSurfaceDestroyed ");
